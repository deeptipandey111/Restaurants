    ...
    <nav id="bt-menu" class="bt-menu">
        ...
        <ul>
		 ...
		 if  (isset($_SESSION["valid"]) and ($_SESSION['valid']==1)){
		  ECHO '<li class="bt-icon"><a href="logout.php">Logout  ,' . $_SESSION['uname'] .'</a></li>';}
		 else {
...
<div class="content"><div class="ic"></div>
  <div class="container_12">
    ...
    <div class="tabs tb gallery">
             ...
             <div class="grid_12">
                 <ul class="nav">
                    ...
                    <li><a href="#tab-5">Photo Gallery</a></li>
                    <li><a href="#tab-6">Leave a message!</a></li>
					<li><a href="#tab-4">rate Us on Zomato!</a></li>
                 </ul>
             </div>    
             </div>
              ...
              <div  id="tab-1" class="tab-content gallery1">
                  <div class="grid_3">
                    <a href="images/cmenu1.jpg" class="gal"><img src="images/cmenu1.jpg" alt=""><span></span></a>
                   
                  </div>
                  <div class="grid_3">
                    <a href="images/cmenu2.jpg" class="gal"><img src="images/cmenu2.jpg" alt=""><span></span></a>
                    
                  </div>
				  <div class="grid_3">
                    <a href="images/cmenu3.jpg" class="gal"><img src="images/cmenu3.jpg" alt=""><span></span></a>
      ...
      <div class="hours">
		...
		<a href="mailto:ankithasri22@gmail.com?cc=deeptipandey111@gmail.com&bcc=ankithasri22@gmail.com&subject=Cafe%20Masala" target="_top">Send us an email!</a>
                 ...
                 <div  id="tab-4" class="tab-content gallery1">
              ...
              <div  id="tab-5" class="tab-content gallery5">
                  <div class="grid_3">
                    <a href="images/cap1.jpg" class="gal"><img src="images/cap1.jpg" alt=""><span></span></a>
                
                  </div>
                  <div class="grid_3">
                    <a href="images/cap2.jpg" class="gal"><img src="images/cap2.jpg" alt=""><span></span></a>
                    
                  </div>
                 
                  <div class="grid_3">
                    <a href="images/cap3.jpg" class="gal"><img src="images/cap3.jpg" alt=""><span></span></a>
                    
                  </div>
				  <div class="grid_3">
                    <a href="images/cap4.jpg" class="gal"><img src="images/cap4.jpg" alt=""><span></span></a>
	...
	<form ... onsubmit="return checkForm(this);" action="caperegisteration.php" method="post">
